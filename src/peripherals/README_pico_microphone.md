# Microphone Library for Pico, adapted for micro_speech example

Fork by IzK from: [Microphone Library for Pico](https://github.com/ArmDeveloperEcosystem/microphone-library-for-pico)
Modified to be used in Arduino IDE, June 2024.
The separate installation and build described below is not required when used in Arduino IDE.
